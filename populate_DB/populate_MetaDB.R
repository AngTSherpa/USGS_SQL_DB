...
##format data before we import it to the database
...
#connect to mysql and populate meatadata database
source("/home/angts/populateDB/dbConnect.R")
on.exit(dbDisconnect(con))
dbListFields(con, "metadata")
##DON'T RUN. Only run this if you need to populate metadata.
